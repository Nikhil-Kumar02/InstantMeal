...
public class SecurityConfig {
    ...
    @Value("${cors.allowed.origins:https://instant-meal-admin.vercel.app,https://instant-meal-customer.vercel.app,http://localhost:8080,http://localhost:3000,http://localhost:3001}")
