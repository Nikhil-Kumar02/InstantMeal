...
import com.instantmeal.foodiesApi.entity.OrderEntity;
import com.instantmeal.foodiesApi.io.OrderRequest;
import com.instantmeal.foodiesApi.io.OrderResponse;
import com.instantmeal.foodiesApi.repository.CartRepository;
import com.instantmeal.foodiesApi.repository.OrderRepository;
...
//        orderRequest.put("amount", newOrder.getAmount() * 100);
        orderRequest.put("amount", (int)(newOrder.getAmount() * 100)); // Razorpay expects paise
